...
set getgucciservice=%pshellrun% "Get-WmiObject -class win32_service -Property pathname, name, displayname, started, processid | select name, displayname, started, processid, pathname | ? started -match 'True'"
